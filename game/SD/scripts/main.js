...

{
    ...
    window._$DOMElementHandler$_ = class extends self._$DOMHandler$_ {
        ...
        _$_OnCreate$_(s) {
            const i = s.elementId, e = this._$CreateElement$_(i, s), n = new t(e);
            this._$_elementMap$_.set(i, n), e.style.boxSizing = "border-box", e.style.display = "none", 
            n._$SetVisibleFlag$_(s.isVisible);
            const h = this._$_GetFocusElement$_(e);
            h.addEventListener("focus", t => this._$_OnFocus$_(i)), h.addEventListener("blur", t => this._$_OnBlur$_(i));
            const o = s.htmlIndex;
            if (n._$SetWantHTMLIndex$_(o), n._$SetHTMLZIndex$_(s.htmlZIndex), this._$_autoAttach$_) {
                const t = this._$GetRuntimeInterface$_()._$GetAvailableHTMLIndex$_(o);
                n._$SetActualHTMLIndex$_(t), this._$GetRuntimeInterface$_()._$GetHTMLWrapElement$_(t).appendChild(e);
            }
        }
        ...
        _$_OnUpdatePosition$_(t) {
            ...
            const h = t.htmlIndex;
            s._$SetWantHTMLIndex$_(h);
            const o = e._$GetAvailableHTMLIndex$_(h);
...

{
    ...
    function h(t) {
        ...
        return s.async = !1, s.type = "module", t._$isStringSrc$_ ? new Promise(i => {
            const e = "c3_resolve_" + n;
            ++n, self[e] = i, s.textContent = t._$str$_ + `\n\nself["${e}"]();`, document.head.appendChild(s);
        }) : new Promise((i, e) => {
    ...
    window._$RuntimeInterface$_ = class t {
        ...
        #x="";
        constructor(t) {
            if (this.#t = t._$useWorker$_, this.#e = t._$scriptFolder$_, this.#x = t._$exportType$_, 
            "playable-ad-single-file" !== this.#x && "playable-ad-zip" !== this.#x && "instant-games" !== this.#x || (this.#t = !1), 
            (e || "macos-wkwebview" === this.#x) && (this.#t = !1), "cordova" === this.#x && this.#t && i) {
                const t = /Chrome\/(\d+)/i.exec(navigator.userAgent);
                t && parseInt(t[1], 10) >= 90 || (this.#t = !1);
            }
            this._$IsAnyWebView2Wrapper$_() ? self.chrome.webview.addEventListener("message", t => this.#P(t.data, t.additionalObjects)) : "macos-wkwebview" === this.#x ? self.C3WrapperOnMessage = t => this.#P(JSON.parse(t)) : "linux-cef" === this.#x && self.c3_linux_cef_set_message_callback(t => this.#P(JSON.parse(t))), 
            this._$_localFileBlobs$_ = null, this._$_localFileStrings$_ = null, "html5" !== this.#x || window.isSecureContext || console.warn("[Construct] Warning: the browser indicates this is not a secure context. Some features may be unavailable. Use secure (HTTPS) hosting to ensure all features are available."), 
            this._$AddRuntimeComponentMessageHandler$_("canvas", "update-size", t => this.#M(t)), 
            this._$AddRuntimeComponentMessageHandler$_("canvas", "set-html-layer-count", t => this._OnSetHTMLLayerCount(t)), 
            this._$AddRuntimeComponentMessageHandler$_("canvas", "cleanup-html-layers", () => this.#C()), 
            this._$AddRuntimeComponentMessageHandler$_("canvas", "update-html-layer-dom-state", t => this.#R(t.layersDomState)), 
            ...
            this._$AddRuntimeComponentMessageHandler$_("runtime", "send-raw-wrapper-extension-message", t => this.#E(t)), 
            "cordova" === this.#x ? document.addEventListener("deviceready", () => this.#A(t)) : this.#A(t), 
            this._$_skipAndroidVirtualKeyboardDetection$_ = 0;
        }
        _$Release$_() {
            this._$_CancelAnimationFrame$_(), this.#s && (this.#s.onmessage = null, this.#s = null), 
            this.#n && (this.#n.terminate(), this.#n = null), this.#h && (this.#h._$Release$_(), 
            this.#h = null);
        ...
        _$IsiOSCordova$_() {
            return s && "cordova" === this.#x;
        }
        _$IsiOSWebView$_() {
            const t = navigator.userAgent;
            return s && p(this.#x) || navigator.standalone || /crios\/|fxios\/|edgios\//i.test(t);
        }
        _$IsAndroid$_() {
            return i;
        }
        ...
        _$IsWindowsWebView2$_() {
            return "windows-webview2" === this.#x || !!("preview" === this.#x && window.chrome && window.chrome.webview && window.chrome.webview.postMessage);
        }
        _$IsAnyWebView2Wrapper$_() {
            return this._$IsWindowsWebView2$_() || "xbox-uwp-webview2" === this.#x;
        }
        ...
        * _$_CanDoAndroidVirtualKeyboardDetection$_() {
        ...
        async #A(t) {
            if (this.#t && (await o() || (this.#t = !1)), "macos-wkwebview" === this.#x && this._$_SendWrapperMessage$_({
                type: "ready"
            }), this._$IsAnyWebView2Wrapper$_() || "macos-wkwebview" === this.#x || "linux-cef" === this.#x) {
                this.#G();
                const t = await this.#F();
                this.#k = t.registeredComponentIds;
            }
            if ("playable-ad-single-file" === this.#x && (this._$_localFileBlobs$_ = self.c3_base64files, 
            ...
            this.#t ? await this.#W(t, s.port2) : await this.#U(t, s.port2);
        }
        #H(s) {
            return {
        ...
        async #W(t, s) {
            ...
            "preview" === this.#x ? (this.#n = new Worker("previewworker.js", {
                type: "module",
                name: "Runtime"
            }), await new Promise((t, s) => {
                const e = i => {
                    this.#n.removeEventListener("message", e), i.data && "ok" === i.data.type ? t() : s();
                };
                this.#n.addEventListener("message", e), this.#n.postMessage({
            ...
            this.#n.postMessage(Object.assign(this.#H(t), {
                type: "init-runtime",
                isInWorker: !0,
                messagePort: s,
                canvas: n,
            ...
            }), [ s, n, ...this.#m._$GetPortTransferables$_() ]), this.#o = c.map(t => new t(this)), 
            this.#V(), this.#r._$_AddDefaultCanvasEventHandlers$_(e), this.#r._$_AddDefaultHTMLWrapEventHandlers$_(h), 
            this.#r._$_EnableWindowResizeEvent$_(), self.c3_callFunction = (t, s) => this.#r._$_InvokeFunctionFromJS$_(t, s), 
            "preview" === this.#x && (self.goToLastErrorScript = () => this._$PostToRuntimeComponent$_("runtime", "go-to-last-error-script"));
        }
        async #U(t, s) {
            ...
            const n = await this.#B(t._$runtimeMainScript$_);
            let o, r;
            ...
            if (a) try {
                if (await h(a), "preview" === this.#x && !globalThis._$C3_ProjectMainScriptOK$_) throw new Error("main script did not run to completion");
            } catch (t) {
            ...
            if (l) try {
                if (await h(l), "preview" === this.#x && !globalThis._$C3$_._$JavaScriptInEvents$_) throw new Error("JavaScript in events did not run to completion");
            } catch (t) {
            ...
            if (u) try {
                if (await h(u), "preview" === this.#x && !globalThis._$C3$_._$TypeScriptInEvents$_) throw new Error("TypeScript in events did not run to completion");
            } catch (t) {
            ...
            this.#r._$_EnableWindowResizeEvent$_(), this.#q(), this.#h = o(d), await r(this.#h, d);
        }
        async _$CreateWorker$_(t, s) {
            if (t.startsWith("blob:")) return new Worker(t, s);
            if ("playable-ad-single-file" === this.#x) {
        ...
        #M(t) {
            ...
            for (const {canvas: t, _$htmlWrap$_: h} of this.#c) t.style.width = s, t.style.height = i, 
            t.style.marginLeft = e, t.style.marginTop = n, h.style.width = s, h.style.height = i, 
            h.style.marginLeft = e, h.style.marginTop = n, this.#a && (t.style.display = "", 
            h.style.display = "");
            document.documentElement.style.setProperty("--construct-scale", t.displayScale), 
            this.#a = !1;
        }
        _OnSetHTMLLayerCount(t) {
            const s = t.count, i = t.layersDomState, e = t.immediate, n = t.styleWidth + "px", h = t.styleHeight + "px", o = t.marginLeft + "px", r = t.marginTop + "px", a = [], c = [];
            if (s < this.#c.length) for (;this.#c.length > s; ) {
                ...
                t.style.width = n, t.style.height = h, t.style.marginLeft = o, t.style.marginTop = r, 
                s.style.width = n, s.style.height = h, s.style.marginLeft = o, s.style.marginTop = r, 
        ...
        #R(t) {
            for (let s = 0, i = Math.min(this.#c.length, t.length); s < i; ++s) {
                const {_$htmlWrap$_: i, _$lastHtmlLayerDomState$_: e} = this.#c[s], n = t[s], h = n.isVisible, o = n.opacity, r = n.isInteractive;
                h !== e.isVisible && (i.style.display = h ? "" : "none", e.isVisible = h), o !== e.opacity && (i.style.opacity = 1 === o ? "" : String(o), 
        ...
        #w() {
            ...
            for (;e < n; ++e) {
                const n = t[e];
                n._$GetActualHTMLIndex$_() !== s && (this.#$(s, t.slice(i, e)), s = n._$GetActualHTMLIndex$_(), 
                i = e);
            }
            i < e && this.#$(s, t.slice(i, e));
        }
        #$(t, s) {
            if (s.length <= 1) return;
            if (t >= this.#c.length) return;
            const i = s.map(t => t._$GetElement$_()), e = new Set(i), n = this._$GetHTMLWrapElement$_(t), h = Array.from(n.children).filter(t => e.has(t));
            for (let t = 0, s = 0, e = i.length; t < e; ++t) {
                const e = i[t], o = h[s];
                e === o ? ++s : n.moveBefore ? n.moveBefore(e, o) : n.insertBefore(e, o);
            }
        }
        _$_OnLocalRuntimeMessageFromDOM$_(t) {
            if (this.#t) throw new Error("not available in worker mode");
            this.#h._OnMessageFromDOM(t);
        }
        ...
        _OnMessageFromRuntime(t) {
            const s = t.type;
            if ("event" === s) return this.#j(t);
            if ("result" === s) this.#z(t); else if ("runtime-ready" === s) this.#Y(); else if ("alert-error" === s) this.#N(), 
        ...
        #j(t) {
            const s = t.component, i = t.handler, e = t.data, n = t.responseId, h = l.get(s);
            if (!h) return void console.warn(`[DOM] No event handlers for component '${s}'`);
            const o = h.get(i);
            ...
            try {
                ...
                return console.error(`Exception in '${s}' handler '${i}':`, t), void (null !== n && this.#X(n, !1, "" + t));
            }
            if (null === n) return r;
            r && r.then ? r.then(t => this.#X(n, !0, t)).catch(t => {
                console.error(`Rejection from '${s}' handler '${i}':`, t), this.#X(n, !1, "" + t);
            }) : this.#X(n, !0, r);
        }
        #X(t, s, i) {
            let e;
        ...
        #z(t) {
            const s = t.responseId, i = t.isOk, e = t.result, n = u.get(s);
            i ? n.resolve(e) : n.reject(e), u.delete(s);
        }
        ...
        _$_RequestAnimationFrame$_() {
            -1 === this.#g && this.#b.size > 0 && (this.#g = requestAnimationFrame(this.#y));
        }
        ...
        _$_SendWrapperMessage$_(t) {
            this._$IsAnyWebView2Wrapper$_() ? window.chrome.webview.postMessage(JSON.stringify(t)) : "macos-wkwebview" === this.#x ? window.webkit.messageHandlers.C3Wrapper.postMessage(JSON.stringify(t)) : "linux-cef" === this.#x && window.c3_linux_cef_sendmessage(JSON.stringify(t));
        }
        #G() {
            window.moveTo = (t, s) => {
                this._$_SendWrapperMessage$_({
        ...
        #it(t) {
            const s = this.#et(t);
            return this.#nt(s.data, s._$mime_type$_);
        }
        #et(t) {
            const s = t.indexOf(",");
        ...
        #nt(t, s) {
            let i, e, n = t.length, h = n >> 2, o = new Uint8Array(n), r = new Uint32Array(o.buffer, 0, h);
            for (i = 0, e = 0; i < h; ++i) r[i] = t.charCodeAt(e++) | t.charCodeAt(e++) << 8 | t.charCodeAt(e++) << 16 | t.charCodeAt(e++) << 24;
            let a = 3 & n;
...
{
    const g = self._$RuntimeInterface$_, y = /firefox/i.test(navigator.userAgent);
    function v(t) {
    ...
    const b = new Map([ [ "OSLeft", "MetaLeft" ], [ "OSRight", "MetaRight" ] ]), S = {
        dispatchRuntimeEvent: !0,
        dispatchUserScriptEvent: !0
    }, k = {
        dispatchUserScriptEvent: !0
    ...
    const P = new Set([ "input", "textarea", "datalist", "select" ]), M = new Set([ "canvas", "body", "html" ]);
    function C(t) {
        if (!t.target.tagName) return;
        const s = t.target.tagName.toLowerCase();
        M.has(s) && t.preventDefault();
    }
    function R(t) {
    ...
    }, self.C3_RasterSvgImageBlob = async function(t, s, i, e, n) {
        const h = await O(t), o = document.createElement("canvas");
        return o.width = e, o.height = n, o.getContext("2d").drawImage(h, 0, 0, s, i), o;
    };
    let I = !1;
    function E() {
        try {
    ...
    document.addEventListener("pause", () => I = !0), document.addEventListener("resume", () => I = !1);
    const A = "runtime", G = class extends self._$DOMHandler$_ {
        #t=-1;
        constructor(t) {
            super(t, A), this._$_enableWindowResizeEvent$_ = !1, this._$_targetOrientation$_ = "any", 
            ...
            if (window.addEventListener("contextmenu", t => {
                ...
                s.has(e) || x(i) || t.preventDefault();
            }), window.addEventListener("selectstart", C), window.addEventListener("gesturehold", C), 
        ...
        _$_AddDefaultCanvasEventHandlers$_(t) {
            t.addEventListener("selectstart", C), t.addEventListener("gesturehold", C), t.addEventListener("pointerdown", C);
        }
        _$_AddDefaultHTMLWrapEventHandlers$_(t) {
            t.addEventListener("selectstart", R), t.addEventListener("gesturehold", R), t.addEventListener("touchstart", R), 
        ...
        _$_OnBeforeStartTicking$_() {
            ...
            this._$_pageVisibilityIsHidden$_ = !("hidden" !== document.visibilityState && !I), 
            {
        ...
        _$Attach$_() {
            ...
            window.addEventListener("blur", () => {
                ...
                var s;
                s = t.target, (P.has(s.tagName.toLowerCase()) || x(s)) && this._$_PostRuntimeEvent$_("keyboard-blur");
            ...
            window.addEventListener("dblclick", t => this._$_OnMouseEvent$_("dblclick", t, S)), 
            window.addEventListener("wheel", t => this._$_OnMouseWheelEvent$_("wheel", t, S)), 
            window.addEventListener("pointerdown", t => {
                this._$_HandlePointerDownFocus$_(t), this._$_OnPointerEvent$_("pointerdown", t);
            }), this._$_iRuntime$_._$UsesWorker$_() && void 0 !== window.onpointerrawupdate && self === self.top && !y ? window.addEventListener("pointerrawupdate", t => this._$_OnPointerRawUpdate$_(t)) : window.addEventListener("pointermove", t => this._$_OnPointerEvent$_("pointermove", t)), 
        ...
        _$_OnAndroidVirtualKeyboardChange$_(t, s) {
            ...
            this._$_vkTranslateYOffset$_ = 0, s > 0) {
                ...
                if (i) {
                    ...
                    let n = (e.top + e.bottom) / 2 - (t - s) / 2;
                    n > s && (n = s), n < 0 && (n = 0), n > 0 && (document.body.style.position = "absolute", 
        ...
        _$_PostRuntimeEvent$_(t, s) {
            this._$PostToRuntime$_(t, s || null, _);
        }
        _$_GetWindowInnerWidth$_() {
        ...
        _$_OnFullscreenChange$_() {
            if (this._$_isExportToVideo$_) return;
            const t = g._$IsDocumentFullscreen$_();
        ...
        _$_OnKeyEvent$_(t, s) {
            ...
            if ("Backspace" === s.key && C(s), "F5" === s.key && "windows-webview2" === this._$_iRuntime$_._$GetExportType$_() && s.preventDefault(), 
            this._$_isExportToVideo$_) return;
            const i = b.get(s.code) || s.code;
        ...
        _$_OnMouseEvent$_(t, s, i) {
            this._$_isExportToVideo$_ || v(s) || this._$_PostToRuntimeMaybeSync$_(t, {
                button: s.button,
                buttons: s.buttons,
                clientX: s.clientX,
                clientY: s.clientY + this._$_vkTranslateYOffset$_,
        ...
        _$_OnPointerEvent$_(t, s) {
            ...
            "mouse" === s.pointerType && (i = this._$_mousePointerLastButtons$_), this._$_PostToRuntimeMaybeSync$_(t, {
                ...
                twist: s.twist || 0,
                timeStamp: s.timeStamp
            }, S), "mouse" === s.pointerType && (this._$_mousePointerLastButtons$_ = s.buttons);
        }
        ...
        _$_OnInvokeDownload$_(t) {
            ...
            e.textContent = i, e.href = s, e.download = i, n.appendChild(e), e.click(), n.removeChild(e);
        }
    ...
    g._$AddDOMHandlerClass$_(G);
}

{
    const F = "dispatchworker.js", D = "jobworker.js";
    self._$JobSchedulerDOM$_ = class {
        ...
        async _$Init$_() {
            ...
            const t = this._$_runtimeInterface$_._$GetScriptFolder$_() + F;
...
{
    const L = "keyboard", W = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, L), this._$_isKeyboardLockSupported$_ = !(!navigator.keyboard || !navigator.keyboard.lock), 
...
{
    const U = "mouse", H = class extends self._$DOMHandler$_ {
        #t=!1;
        #s=!1;
        #r="";
        constructor(t) {
            super(t, U), this._$AddRuntimeMessageHandlers$_([ [ "init", t => this.#n(t) ], [ "cursor", t => this.#i(t) ], [ "request-pointer-lock", t => this.#h(t) ], [ "release-pointer-lock", () => this.#e() ] ]), 
...
{
    const V = 180 / Math.PI, B = "audio";
    self._$AudioDOMHandler$_ = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, B), this._$_audioContext$_ = null, this._$_destinationNode$_ = null, this._$_hasAttachedUnblockEvents$_ = !1, 
        ...
        * _$audioInstancesByEffectTag$_(t) {
        ...
        async _$_GetAudioBuffer$_(t, s, i, e, n) {
            ...
            return this._$_audioBuffers$_.push(h), e && this._$_playMusicAsSound$_ && (this._$_lastMusicBuffer$_ = h), 
            await h._$Load$_(), this._$_loadedAudioUrls$_.has(t) || (this._$PostToRuntime$_("buffer-metadata", {
                originalUrl: t,
                duration: h._$GetDuration$_()
            }), this._$_loadedAudioUrls$_.add(t)), h;
        }
        async _$_GetAudioInstance$_(t, s, i, e, n) {
            for (const t of this._$_audioInstances$_) if (t._$GetUrl$_() === s && (t._$CanBeRecycled$_() || n)) return n && this._$_playMusicAsSound$_ && (this._$_lastMusicBuffer$_ = t._$GetBuffer$_()), 
            t._$SetTags$_(e), t;
            const h = await this._$_GetAudioBuffer$_(t, s, i, n);
            if (h._$WasReleased$_()) throw new Error(`buffer '${t}' unloaded while loading`);
            const o = h._$CreateInstance$_(e);
        ...
        async _$_Play$_(t) {
            ...
            let u = t.off;
            u > 0 && !t.trueClock && (u += this._$GetAudioCurrentTime$_()), this._$_lastPlayedTags$_ = h.slice(0), 
            this._$_AddPendingTags$_(h);
            try {
                this._$_lastAudioInstance$_ = await this._$_GetAudioInstance$_(s, i, e, h, n), c ? (this._$_lastAudioInstance$_._$SetPannerEnabled$_(!0), 
        ...
        async _$_FadeVolume$_(t) {
            ...
            await this._$TagsReady$_(s);
            for (const t of this._$audioInstancesMatchingTags$_(s)) t._$FadeVolume$_(i, e, n);
            this._$_MaybeStartTicking$_();
        }
        ...
        async _$_Unload$_(t) {
            ...
            if (!n) return;
            n._$Release$_(), this._$_lastMusicBuffer$_ === n && (this._$_lastMusicBuffer$_ = null);
        ...
        _$_SetEffectParam$_(t) {
            ...
            for (const t of s) {
                const s = this._$_effects$_.get(t.toLowerCase());
                !s || i < 0 || i >= s.length || s[i]._$SetParam$_(e, n, h, o);
            }
            this._$_PostUpdatedFxState$_();
        }
        ...
        async _$_OnLoadState$_(t) {
            ...
            const n = [];
            for (const s of Object.values(t.effects)) n.push(Promise.all(s.map(t => this._$_AddEffect$_(t))));
            await Promise.all(n), await Promise.all(t.playing.map(t => this._$_LoadAudioInstance$_(t, s))), 
            this._$_MaybeStartTicking$_();
        }
        async _$_LoadAudioInstance$_(t, s) {
            if (3 === s) return;
            const i = t.bufferOriginalUrl, e = t.bufferUrl, n = t.bufferType, h = t.isMusic, o = t.tags, r = t.isLooping, a = t.volume, c = t.playbackTime;
            if (h && 1 === s) return;
            if (!h && 2 === s) return;
            let l = null;
            try {
                l = await this._$_GetAudioInstance$_(i, e, n, o, h);
            } catch (t) {
...
self._$C3AudioBuffer$_ = class {
    constructor(t, s, i, e, n) {
        ...
        this._$_isMusic$_ = n, this._$_api$_ = "", this._$_loadState$_ = "not-loaded", this._$_loadPromise$_ = null;
    }
    _$Release$_() {
    ...
    static _$Create$_(t, s, i, e, n) {
        return !n || t._$IsPlayMusicAsSound$_() ? new self._$C3WebAudioBuffer$_(t, s, i, e, n) : new self._$C3Html5AudioBuffer$_(t, s, i, e, n);
    }
    ...
    constructor(t, s, i, e, n) {
        super(t, s, i, e, n), this._$_api$_ = "webaudio", this._$_audioData$_ = null, this._$_audioBuffer$_ = null;
    }
    _$Release$_() {
...

{
    ...
    self._$C3AudioInstance$_ = class {
        ...
        _$FadeVolume$_(t, s, i) {
            ...
            const n = this._$_audioDomHandler$_._$GetAudioCurrentTime$_(), h = n + s;
        ...
        _$SetPanXYZA$_(t, s, i, e) {
            ...
            n[0] === t && n[1] === s && n[2] === i || (n[0] = t, n[1] = s, n[2] = i, this._$_pannerNode$_.setPosition(...n)), 
            h[0] === o && h[1] === r && 0 === h[2] || (h[0] = o, h[1] = r, h[2] = 0, this._$_pannerNode$_.setOrientation(...h));
        }
...
self._$C3Html5AudioInstance$_ = class extends self._$C3AudioInstance$_ {
    ...
    Play(t, s, i, e) {
        ...
        this._$SetVolume$_(s), this._$_isMuted$_ = !1, n.muted && (n.muted = !1), n.currentTime !== i) try {
            n.currentTime = i;
        } catch (t) {
            console.warn(`[Construct] Exception seeking audio '${this._$_buffer$_._$GetUrl$_()}' to position '${i}': `, t);
        }
        this._$_audioDomHandler$_._$TryPlayMedia$_(n), this._$_isStopped$_ = !1, this._$_isPaused$_ = !1, 
...

{
    ...
    self._$C3AudioFilterFX$_ = class extends q {
        constructor(t, s, i, e, n, h, o) {
            super(t), this._$_type$_ = "filter", this._$_params$_ = [ s, i, e, n, h, o ], this._$_inputNode$_ = this._$CreateGain$_(), 
            ...
            this._$_filterNode$_.Q.value = n, this._$_filterNode$_.gain.vlaue = h, this._$_inputNode$_.connect(this._$_filterNode$_), 
        ...
        constructor(t, s, i, e, n, h) {
            super(t), this._$_type$_ = "flanger", this._$_params$_ = [ s, i, e, n, h ], this._$_inputNode$_ = this._$CreateGain$_(), 
            this._$_dryNode$_ = this._$CreateGain$_(), this._$_dryNode$_.gain.value = 1 - h / 2, 
            this._$_wetNode$_ = this._$CreateGain$_(), this._$_wetNode$_.gain.value = h / 2, 
            this._$_feedbackNode$_ = this._$CreateGain$_(), this._$_feedbackNode$_.gain.value = n, 
        ...
        constructor(t, s, i, e, n, h, o) {
            super(t), this._$_type$_ = "phaser", this._$_params$_ = [ s, i, e, n, h, o ], this._$_inputNode$_ = this._$CreateGain$_(), 
            ...
            this._$_oscNode$_.frequency.value = h, this._$_oscGainNode$_ = this._$CreateGain$_(), 
            this._$_oscGainNode$_.gain.value = n, this._$_inputNode$_.connect(this._$_filterNode$_), 
            this._$_inputNode$_.connect(this._$_dryNode$_), this._$_filterNode$_.connect(this._$_wetNode$_), 
        ...
        constructor(t, s, i, e, n, h) {
            super(t), this._$_type$_ = "distortion", this._$_params$_ = [ s, i, e, n, h ], this._$_inputNode$_ = this._$CreateGain$_(), 
            this._$_preGain$_ = this._$CreateGain$_(), this._$_postGain$_ = this._$CreateGain$_(), 
            this._$_SetDrive$_(e, n), this._$_wetNode$_ = this._$CreateGain$_(), this._$_wetNode$_.gain.value = h, 
        ...
        _$_GenerateColortouchCurve$_(t, s) {
            ...
            for (let e = 0; e < i; ++e) {
                let n = e / i;
                n = this._$_Shape$_(n, t, s), this._$_curve$_[i + e] = n, this._$_curve$_[i - e - 1] = -n;
            }
        }
        _$_Shape$_(t, s, i) {
            const e = 1.05 * i * s - s, n = t < 0 ? -1 : 1, h = t < 0 ? -t : t;
            let o = h < s ? h : s + e * self._$AudioDOMHandler$_._$e4$_(h - s, 1 / e);
            return o *= n, o;
        }
        _$ConnectTo$_(t) {
            this._$_wetNode$_.disconnect(), this._$_wetNode$_.connect(t), this._$_dryNode$_.disconnect(), 
        ...
        constructor(t, s, i, e, n, h) {
            super(t), this._$_type$_ = "compressor", this._$_params$_ = [ s, i, e, n, h ], this._$_node$_ = this._$_audioContext$_.createDynamicsCompressor(), 
...

{
    ...
    function Y() {}
    window.addEventListener("beforeinstallprompt", t => (t.preventDefault(), $ = t, 
    j && j._$_OnBeforeInstallPrompt$_(), !1));
    const X = "browser", J = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, X), this._$_exportType$_ = "", this._$AddRuntimeMessageHandlers$_([ [ "get-initial-state", t => this._$_OnGetInitialState$_(t) ], [ "ready-for-sw-messages", () => this._$_OnReadyForSWMessages$_() ], [ "alert", t => this._$_OnAlert$_(t) ], [ "close", () => this._$_OnClose$_() ], [ "set-focus", t => this._$_OnSetFocus$_(t) ], [ "vibrate", t => this._$_OnVibrate$_(t) ], [ "lock-orientation", t => this._$_OnLockOrientation$_(t) ], [ "unlock-orientation", () => this._$_OnUnlockOrientation$_() ], [ "navigate", t => this._$_OnNavigate$_(t) ], [ "request-fullscreen", t => this._$_OnRequestFullscreen$_(t) ], [ "exit-fullscreen", () => this._$_OnExitFullscreen$_() ], [ "set-hash", t => this._$_OnSetHash$_(t) ], [ "set-document-css-style", t => this._$_OnSetDocumentCSSStyle$_(t) ], [ "get-document-css-style", t => this._$_OnGetDocumentCSSStyle$_(t) ], [ "set-window-size", t => this._$_OnSetWindowSize$_(t) ], [ "set-window-position", t => this._$_OnSetWindowPosition$_(t) ], [ "request-install", () => this._$_OnRequestInstall$_() ], [ "set-warn-on-close", t => this._$_OnSetWarnOnClose$_(t) ] ]), 
            window.addEventListener("online", () => this._$_OnOnlineStateChanged$_(!0)), window.addEventListener("offline", () => this._$_OnOnlineStateChanged$_(!1)), 
            window.addEventListener("hashchange", () => this._$_OnHashChange$_()), window.addEventListener("fullscreenerror", () => this._$_OnFullscreenError$_()), 
            window.addEventListener("webkitfullscreenerror", () => this._$_OnFullscreenError$_()), 
            window.addEventListener("mozfullscreenerror", () => this._$_OnFullscreenError$_()), 
            this._$_beforeunload_handler$_ = t => t.preventDefault(), document.addEventListener("backbutton", () => this._$_OnCordovaBackButton$_());
        }
        _$Attach$_() {
            $ ? this._$_OnBeforeInstallPrompt$_() : j = this, window.addEventListener("appinstalled", () => this._$_OnAppInstalled$_());
        }
        ...
        async _$_OnRequestInstall$_() {
            ...
            try {
                return $.prompt(), {
                    result: (await $.userChoice).outcome
                };
            } catch (t) {
        ...
        _$_OnSetFocus$_(t) {
            t.isFocus ? window.focus() : window.blur();
        }
        _$_OnVibrate$_(t) {
        ...
        _$_OnNavigate$_(t) {
            ...
            if ("back" === s) navigator.app && navigator.app.backHistory ? navigator.app.backHistory() : window.history.back(); else if ("forward" === s) window.history.forward(); else if ("reload" === s) location.reload(); else if ("url" === s) {
                const s = t.url, i = t.target, e = t.exportType;
                self.cordova && self.cordova.InAppBrowser ? self.cordova.InAppBrowser.open(s, "_system") : "preview" === e || "macos-wkwebiew" === e || "linux-cef" === e || this._$_iRuntime$_._$IsAnyWebView2Wrapper$_() ? window.open(s, "_blank") : this._$_isConstructArcade$_ || (2 === i ? window.top.location = s : 1 === i ? window.parent.location = s : window.location = s);
            } else if ("new-window" === s) {
                const s = t.url, i = t.tag;
                self.cordova && self.cordova.InAppBrowser ? self.cordova.InAppBrowser.open(s, "_system") : window.open(s, i);
            }
        }
        _$_OnRequestFullscreen$_(t) {
            ...
            this._$_iRuntime$_._$_SendWrapperMessage$_({
                ...
                1 === i ? s.navigationUI = "hide" : 2 === i && (s.navigationUI = "show");
                const e = document.documentElement;
                let n;
                e.requestFullscreen ? n = e.requestFullscreen(s) : e.mozRequestFullScreen ? n = e.mozRequestFullScreen(s) : e.msRequestFullscreen ? n = e.msRequestFullscreen(s) : e.webkitRequestFullScreen && (n = void 0 !== Element.ALLOW_KEYBOARD_INPUT ? e.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT) : e.webkitRequestFullScreen()), 
                n instanceof Promise && n.catch(Y);
            }
        }
        _$_OnFullscreenError$_() {
            this._$PostToRuntime$_("fullscreenerror");
        }
        _$_OnExitFullscreen$_() {
            ...
            this._$_iRuntime$_._$_SendWrapperMessage$_({
                ...
                t instanceof Promise && t.catch(Y);
            }
        }
        _$_OnSetHash$_(t) {
        ...
        _$_OnSetDocumentCSSStyle$_(t) {
            ...
            try {
                const t = z(e, n);
                for (const e of t) s.startsWith("--") ? e.style.setProperty(s, i) : e.style[s] = i;
            } catch (t) {
        ...
        _$_OnGetDocumentCSSStyle$_(t) {
            ...
            try {
                ...
                return t ? {
                    isOk: !0,
                    result: window.getComputedStyle(t).getPropertyValue(s)
                } : {
                    isOk: !1
                };
            } catch (t) {
        ...
        _$_OnSetWarnOnClose$_(t) {
            t.enabled ? window.addEventListener("beforeunload", this._$_beforeunload_handler$_) : window.removeEventListener("beforeunload", this._$_beforeunload_handler$_);
        }
    };
...
{
    const K = "localstorage", Z = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, K), this._$AddRuntimeMessageHandlers$_([ [ "init", () => this._$_Init$_() ], [ "request-persistent", () => this._$_OnRequestPersistent$_() ] ]);
        }
        async _$_Init$_() {
            let t = !1;
            try {
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(Z);
}

{
    const Q = "touch", tt = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, Q), this._$AddRuntimeMessageHandler$_("request-permission", t => this._$_OnRequestPermission$_(t));
        }
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(tt);
}

{
    ...
    const nt = class extends self._$DOMElementHandler$_ {
        constructor(t) {
            super(t, st), this._$AddDOMElementMessageHandler$_("scroll-to-bottom", t => this._$_OnScrollToBottom$_(t));
        }
        _$CreateElement$_(t, s) {
            let i;
            const e = s.type;
            return "textarea" === e ? (i = document.createElement("textarea"), i.style.resize = "none") : (i = document.createElement("input"), 
            i.type = e), i.style.position = "absolute", i.autocomplete = "off", i.addEventListener("pointerdown", it), 
            i.addEventListener("pointerrawupdate", it), i.addEventListener("pointerup", it), 
            i.addEventListener("mousedown", it), i.addEventListener("mouseup", it), i.addEventListener("keydown", et), 
            i.addEventListener("keyup", et), i.addEventListener("click", s => {
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(nt);
}
